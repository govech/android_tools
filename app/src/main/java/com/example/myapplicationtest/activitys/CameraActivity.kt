...
import com.example.myapplicationtest.databinding.ActivityCameraBinding
...
class CameraActivity : BaseActivity() {
    private val mBinding by binding(ActivityCameraBinding::inflate)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startCamera()
        mBinding.imageCaptureButton.click {
            takePhoto()
        }
    }
