...
import com.sword.tools.databinding.ItemNestedInnerRvBinding
...
class InnerRvContentAdapter(private val itemCount: Int) : RecyclerView.Adapter<InnerRvContentAdapter.ContentViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContentViewHolder {
        val binding = com.sword.tools.databinding.ItemInnerRvContentBinding.inflate(
            LayoutInflater.from(parent.context),
            parent,
            false
        )
    ...
    inner class ContentViewHolder(private val binding: com.sword.tools.databinding.ItemInnerRvContentBinding) :
        RecyclerView.ViewHolder(binding.root) {
